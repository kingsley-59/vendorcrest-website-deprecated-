...
if($_GET['subcat']=='add-home-content'){
   ...
   $firstTitle= $editData['title'];
   $secondTitle= $editData['subtitle'];
	...
	<div class="row">
		<div class="col">
			  <div class="form-group">
            	...
            	<input class="form-control" name="content_section" value="<?php echo $contentSection ?>" placeholder="Content section">
...
<?php }elseif (!empty($_GET['view'])) {?>
  ...
  $id= $_GET['view'];
   ...
   $backId=$viewData['id']-1;
    $firstTitle=$viewData['title'];
    $secondTitle=$viewData['subtitle'];
